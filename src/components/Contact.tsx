      ...
      <div className="container-max">
        ...
        >
          ...
          <p className="section-subtitle">
            Ready to create something beautiful? Reach out to us and let's start 
            planning your dream event together.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-heading font-semibold text-secondary mb-1">Call Us</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-heading font-semibold text-secondary mb-1">Email Us</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-heading font-semibold text-secondary mb-1">Visit Us</h4>
                  <p className="font-body text-sm text-muted-foreground">Hawassa, SNNPR, Ethiopia<br />Near Piazza, Main Road</p>
                </div>
              </div>
            </div>
          ...
          >
            <form onSubmit={handleSubmit} className="bg-card rounded-lg p-8 sm:p-10 shadow-sm border border-border/50 space-y-6">
              <div>
                <label className="font-body text-sm font-medium text-secondary block mb-2">Full Name</label>
                <input
                  type="text"
                  required
                  value={form.name}
                  ...
                  className="w-full px-4 py-3 rounded-md border border-input bg-background font-body text-sm focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold transition-all"
                />
              </div>

              <div>
                <label className="font-body text-sm font-medium text-secondary block mb-2">Email Address</label>
                <input
                  type="email"
                  required
                  value={form.email}
              ...
              <div>
                <label className="font-body text-sm font-medium text-secondary block mb-2">Your Message</label>
                <textarea
                  required
                  rows={5}
                  value={form.message}
                  ...
                  className="w-full px-4 py-3 rounded-md border border-input bg-background font-body text-sm focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold transition-all resize-none"
                />
              </div>
              ...
              {submitted && (
                <motion.p
                  ...
                  className="text-center font-body text-sm text-green-600"
                >
